...
let articulosDeAseo = [
    {id:7,nombre:'Detergente',detalle:'En polvo 650g',precio:1,img:'./../../img/Productos/Aseo/1.jpg'},
    {id:8,nombre:'Jabon Mundial',detalle:'En barra',precio:1,img:'./../../img/Productos/Aseo/2.jpg'},
    {id:9,nombre:'Detergente',detalle:'En polvo',precio:1,img:'./../../img/Productos/Aseo/3.jpg'},
    {id:10,nombre:'Lava Vajillas',detalle:'Sapolio 750ml',precio:1,img:'./../../img/Productos/Aseo/4.jpg'},
    {id:11,nombre:'Hisopos',detalle:'De 100 Unidades',precio:1,img:'./../../img/Productos/Aseo/5.jpg'},
    {id:12,nombre:'Cepillo',detalle:'Para ropa',precio:1,img:'./../../img/Productos/Aseo/6.jpg'},
    {id:13,nombre:'Papel higienico',detalle:'Paquete 1 docena',precio:1,img:'./../../img/Productos/Aseo/7.jpg'}
]
   ...
   targeta.innerHTML = `
      ...
      <div class="contenido">
          ...
          ${localStorage.getItem("admin") === "true"
            ? `<p class="precioClas" contenteditable="true" onblur="actualizarPrecioAseo(${i}, this.innerText)"><b>Bs.</b> ${art.precio}</p>`
