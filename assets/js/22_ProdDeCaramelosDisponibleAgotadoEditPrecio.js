...
let articulosDeCaramelos = [
    {id:14,nombre:'Yogurello',detalle:'95ml',precio:1,img:'./../../img/Productos/Caramelos/1.jpg'},
    {id:15,nombre:'Pilfrut',detalle:'175ml',precio:1,img:'./../../img/Productos/Caramelos/2.jpg'},
    {id:16,nombre:'Juguito PIL',detalle:'150ml',precio:1,img:'./../../img/Productos/Caramelos/3.jpg'},
    {id:17,nombre:'Galletas Jirafa',detalle:'Craker 250g',precio:1,img:'./../../img/Productos/Caramelos/4.jpg'},
    {id:18,nombre:'Galleta Moradita',detalle:'Saladita 90g',precio:1,img:'./../../img/Productos/Caramelos/5.jpg'},
    {id:19,nombre:'Galleta Maria',detalle:'Dulce de 90g',precio:1,img:'./../../img/Productos/Caramelos/6.jpg'},
    {id:20,nombre:'Galleta Mabel',detalle:'100g',precio:1,img:'./../../img/Productos/Caramelos/7.jpg'},
    {id:21,nombre:'Chicolac',detalle:'120ml',precio:1,img:'./../../img/Productos/Caramelos/8.jpg'}
]
   ...
   targeta.innerHTML = `
      ...
      <div class="contenido">
          ...
          ${localStorage.getItem("admin") === "true"
            ? `<p class="precioClas" contenteditable="true" onblur="actualizarPrecioCaramelo(${i}, this.innerText)"><b>Bs.</b> ${art.precio}</p>`
