...
let articulosDeEnergeticos = [
    {id:40,nombre:'Energizante',detalle:'350ml',precio:1,img:'./../../img/Productos/Energeticos/1.jpg'},
    {id:41,nombre:'Energizante',detalle:'473ml',precio:1,img:'./../../img/Productos/Energeticos/2.jpg'},
    {id:42,nombre:'Energizante',detalle:'350ml',precio:1,img:'./../../img/Productos/Energeticos/3.jpg'}
]
   ...
   targeta.innerHTML = `
      ...
      <div class="contenido">
          ...
          ${localStorage.getItem("admin") === "true"
            ? `<p class="precioClas" contenteditable="true" onblur="editarPrecioEnergetico(${i}, this.innerText)"><b>Bs.</b> ${art.precio}</p>`
